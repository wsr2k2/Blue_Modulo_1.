...
console.log(
  "\033[1;35m\nDaqui pra frente você será lembrado como: " +
    pessoa.nome +
    " - A(O) ESTÁGIARIA(O)\033[0m"
);
console.log();
console.log(
  "\033[1;36m============================================================================================"
...
function jogo() {
  while (true) {
    ...
    if (escolha1 == 1) {
      console.log(
        "Escolheu levantar....Então borá lá enfrentar mais um dia de tramapo!"
      );
      // ESCOLHA DORMIR MAIS
    }
    if (escolha1 == 2) {
      console.log(
        "Escolheu dormir mais 5 minutinhos....Você acordou atrasado, agora bora correr contra o tempo, chegar atrasado vai ser zuado!"
      );
    }
    ...
    if (escolha1 == 2) {
      console.log(
        "Você levanta atrasado e sai correndo para o trampo, já imaginando que vai ouvir um monte....Ao chegar lá seu líder te xinga um monte e te passa uma porrada de coisas..."
      );
    }
    ...
    if (escolha2 == 1) {
      console.log(
        "Durante o café vocês combinam de sair a noite para umas brejas.... Pretendem sair no horário normal, às 18:00H... logo depois você volta para seu setor."
      );
    }
    if (escolha2 == 2) {
      console.log(
        "Você escolhe ficar trabalhando e perde a chance de descontrair com os colegas......"
      );
    }
