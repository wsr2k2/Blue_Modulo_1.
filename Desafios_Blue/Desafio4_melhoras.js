...
function autorizaVoto(nascimento) {
  if (nascimento >= 2006) {
    ...
    console.log("\033[1;33m PREZADO ELEITOR: Você está obrigado a votar!\n");
  }
}
...
function exibirResultados(listaVotados) {
  ...
  if (candidato1 > candidato2 && candidato1 > candidato3) {
    ...
    return console.log(
      "Deu empate entre o candidato 1 e o candidato 3, terá segundo turno!"
    );
  } else if (candidato1 > candidato3 && candidato1 == candidato2) {
    return console.log(
      "Deu empate entre o candidato 1 e o candidato 2, terá segundo turno!"
    );
  } else if (candidato2 > candidato1 && candidato1 == candidato3) {
    return console.log(
      "Deu empate entre o candidato 2 e o candidato 3, terá segundo turno!"
    );
  } else
